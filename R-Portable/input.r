...
initVar <- read.csv("C:/Users/Sam/Documents/NetBeansProjects/pume/PuMe2019/R-Portable/Rprebas_examples-master/inputs/initVar_speciesId_test.csv",header = T, row.names = 1)
