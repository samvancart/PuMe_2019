...
PREBASout <- prebas(nYears=100,pCROBAS = pCROB, pPRELES = pPREL,siteInfo = c(1,1,1),thinning = thinning,PAR=PAR,TAir=TAir,VPD=VPD,Precip=Precip,CO2=CO2,P0=NA,initVar = as.matrix(initVar),defaultThin = 0.,ClCut = 1.,inDclct = NA,inAclct = NA)
client <- function(){
